...
if ($op == 'delete') {
    ...
    $q1 = mysqli_query($koneksi, $sql1);  // Fixed typo here
    if ($q1) {
...
<nav aria-label="Page-navigation example">
    <ul class="pagination">
        ...
        ?>
            <li class="page-item">
                <a class="page-link" href="halaman.php?katakunci=<?php echo urlencode($katakunci) ?>&cari=<?php echo urlencode($cari) ?>&page=<?php echo $i; ?>">
                    <?php echo $i; ?>
                </a>
            </li>
        <?php
